...
create_course_request = CreateCourseRequestDict(
    ...
    maxScore = 100,
    minScore = 10,
    description = "About API testing using Playwright",
...
create_exercise_request = CreateExerciseRequestDict(
    title = "Exercise 1: Practice with HTTPX",
    courseId = create_course_response['course']['id'],
    maxScore = 10,
    minScore = 1,
    orderIndex = 0,
    description = "Create user using POST request to the /api/v1/users endpoint",
